...
void CD3D12SettingsPPage::UpdateCurrentScaler()
{
	...
	CScalerOption* opt;
	int currentupscaler = D3D12Engine::g_D3D12Options->GetCurrentUpscaler();
	//bilinear
	if (currentupscaler == 0)
	{
	...
	//Jinc
	if (currentupscaler == 5)
	{
		
	}
	//super xbr
	if (currentupscaler == 6)
	{
